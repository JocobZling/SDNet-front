...
import {Button, Row, Steps, Col, Switch, Image, Input, message, Badge, Avatar} from 'antd';
import {saveAs} from 'file-saver'
import {
    SearchOutlined,
    DownloadOutlined, AccountBookOutlined,
} from '@ant-design/icons';
import EdgeServer1 from '../../images/SplicingTop.svg';
import EdgeServer2 from '../../images/SplicingBottom.svg';
...
const Result1FontStyle = styled('div')`
    font-size:20px;
    font-weight:700;
    padding-top:20px;
`
const Result2FontStyle = styled('div')`
    font-size:20px;
    font-weight:700;
    margin-bottom:10px;
`
    ...
    const begin = async () => {
        ...
        if (needdata <= leftdata) {
            ...
            if (res.body.costresult === "costsuccess") {
                ...
                beginDetection(detectionId, type);
                getDetectionDetail(detectionId, type);
            } else {
            ...
            <Row justify="space-around" align="middle">
                <Col span={24}>
                    <Steps current={current} style={{marginTop: '5px'}}>
                        ...
                        <Step title="自适应残差模块" description="模块协议交互中"/>
                        <Step title="通道注意力模块" description="模块协议交互中"/>
                        <Step title="EfficientNetB0" description="模块协议交互中"/>
            ...
            <Row justify={'center'} align={'middle'}>
                <Col span={21}>
                    <Row justify={'center'} align={'middle'}>
                        ...
                        <Col span={3}>
                            <Result1FontStyle>{result !== undefined ? result[0] : ""}</Result1FontStyle>
                        </Col>
                    </Row>
                    <Row align={'middle'}>
                        <Col offset={5} span={3}>
                            <Image src={Reaction1} preview={false} height={130}/>
                        </Col>
                        <Col span={7}>
                            <div style={{
                                maxHeight: '120px',
                        ...
                        <Col span={3}>
                            <Image src={Reaction2} preview={false} height={130}/>
                        </Col>
                        <Col span={2} offset={1}>
                    ...
                    <Row justify={'center'} align={'middle'}>
                        ...
                        <Col span={3}>
                            <Result2FontStyle>{result !== undefined ? result[1] : ""}</Result2FontStyle>
                        </Col>
                    </Row>
                </Col>
                <Col span={3}>
                    <Row justify={'center'} align={'middle'}>
                        <Col span={12}>
                            <img src={Line} style={{height: '360px', marginTop: '10px'}}/>
                        </Col>
                        {type === 'video' ?
                            <Col span={12}>
                                {flag !== "" ? (
                                            ...
                                            flag === true ?
                                                <Badge count={<img src={True} style={{
                                                    ...
                                                    height: 'auto'
                                                       ...
                                                       offset={[-50, 50]}>
                                                    <Avatar shape="square" style={{width: '100px', height: 'auto'}}
                                                            src={originalPath}/>
                                                </Badge> :
                                                <Badge count={<img src={False} style={{
                                                    zIndex: 999,
                                                    width: '50px',
                                                    height: '50px'
                                                }}/>} offset={[-50, 40]}>
